...
const EMISSIONS_SOURCES = {
  ...
  fao_gleam: {
    ...
    citation:
      "FAO (2023). Global Livestock Environmental Assessment Model (GLEAM). Food and Agriculture Organization.",
  ...
  agribalyse: {
    ...
    type: "lca_database",
    citation:
      "ADEME (2023). Agribalyse: Environmental database for food products. French Agency for Ecological Transition.",
...
const PRODUCT_EMISSIONS_MAP = [
  {
    keywords: ["beef", "steak", "ribeye", "brisket", "sirloin", "mince", "minced beef"],
    sources: ["poore_nemecek", "owid", "fao_gleam"],
  },
  { keywords: ["lamb", "mutton"], sources: ["poore_nemecek", "owid", "fao_gleam"] },
  {
    keywords: ["pork", "bacon", "ham", "sausage", "luncheon", "wonton"],
    sources: ["poore_nemecek", "owid", "fao_gleam"],
  },
  {
    keywords: [
  ...
  {
    keywords: ["tofu", "tempeh", "seitan", "plant-based", "quorn"],
    sources: ["poore_nemecek", "owid", "agribalyse"],
  },
  {
    keywords: ["salmon", "trout", "barramundi", "cod"],
    sources: ["poore_nemecek", "owid", "fao_gleam"],
  },
  { keywords: ["tuna", "sardine", "mackerel", "anchov"], sources: ["poore_nemecek", "owid"] },
  {
    keywords: ["prawn", "shrimp", "lobster", "crab", "scallop", "clam"],
    sources: ["poore_nemecek", "owid", "fao_gleam"],
  },
  ...
  {
    keywords: ["milk", "yogurt", "yoghurt", "cream", "butter", "ghee", "yakult", "ice cream"],
    sources: ["poore_nemecek", "owid", "fao_gleam"],
  },
  {
    keywords: [
    ...
    sources: ["poore_nemecek", "owid"],
  },
  {
    keywords: ["rice", "jasmine", "basmati", "glutinous", "bee hoon", "vermicelli"],
    sources: ["poore_nemecek", "owid"],
  },
  {
    keywords: [
  ...
  {
    keywords: ["tea", "chrysanthemum", "barley", "winter melon"],
    sources: ["poore_nemecek", "owid"],
  },
  {
    keywords: [
  ...
  {
    keywords: ["sugar", "honey", "condensed milk", "evaporated milk"],
    sources: ["poore_nemecek", "owid"],
  },
  ...
  {
    keywords: ["soy milk", "oat milk", "almond milk", "soy bean milk"],
    sources: ["poore_nemecek", "owid", "agribalyse"],
  },
  {
    keywords: ["juice", "sparkling", "isotonic", "milo", "ribena", "100 plus"],
    sources: ["agribalyse", "openfoodfacts"],
  },
  {
    keywords: ["coconut water", "coconut cream", "coconut milk"],
    sources: ["poore_nemecek", "owid"],
  },
  ...
  {
    keywords: ["biscuit", "cracker", "wafer", "cookie", "oreo", "waffle"],
    sources: ["agribalyse", "openfoodfacts"],
  },
...
const updatedProducts = products.map((product) => {
  ...
  const dataSources = {
    ...
    productInfo: {
      ...
      methodology:
        "Product-level emissions estimated from peer-reviewed LCA literature, with category-average baselines from Poore & Nemecek (2018). Breakdown covers 7 supply chain stages: land use change, animal feed, farm, processing, transport, packaging, and retail.",
      lastUpdated: "2025-01",
    },
  };
