    ...
    <div>
      ...
      >
        {breakdown.map((b, i) => (
          <React.Fragment key={b.category}>
            ...
            >
              <span>{STAGE_ICONS[b.category] || ""}</span>
              {b.category}
            </span>
            {i < breakdown.length - 1 && (
              <span style={{ color: "#ccc", fontSize: "0.8rem" }}>&rarr;</span>
            )}
          </React.Fragment>
        ))}
      </div>
        ...
        {enriched.map((b, i) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 10 }}>
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background: scoreBg(b.categoryScore),
                  border: `2px solid ${scoreRing(b.categoryScore)}`,
                  display: "flex",
                  alignItems: "center",
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  ...
                  >
                    <span style={{ fontSize: "0.85rem" }}>{STAGE_ICONS[b.category] || ""}</span>
                    {b.category}
                  </span>
                  <span
                    style={{
            ...
            >
              ...
              <span>
                Contributes <strong style={{ color: "#555" }}>+{b.contribution}</strong> to total
              </span>
            </div>
          </div>
        ))}
      ...
      <div
        style={{
          marginTop: 18,
          padding: "16px 18px",
          background: "linear-gradient(135deg, #edf7f0 0%, #d8f3dc 100%)",
          borderRadius: 14,
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            ...
            <div style={{ fontSize: "0.8rem", color: "#40916c", marginTop: 2 }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            >
              ...
              <span style={{ fontSize: "0.85rem", color: "#888", fontWeight: 400 }}> / 10</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <span
            style={{
              ...
              color:
                (totalScore || computedTotal) >= 4 && (totalScore || computedTotal) < 7
                  ? "#1a1a2e"
                  : "#fff",
              fontWeight: 700,
            }}
        ...
        <div style={{ fontSize: "0.8rem", color: "#40916c", marginTop: 10 }}>
          Total emissions:{" "}
          <strong style={{ color: "#1b4332" }}>{totalEmissions} kg CO&#8322;e/kg</strong>
        </div>
      </div>
    </div>
  );
