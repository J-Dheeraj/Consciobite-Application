...
**Last updated:** 2026-08-15 — all PRs merged; admin evidence review panel added on branch `claude/nifty-goodall-60xw2a`.
...
**Open PRs:** All previous PRs (#34–#41, #44–#47) are merged. Branch `claude/nifty-goodall-60xw2a` is open with the evidence review panel (not yet PRed).
