...
**Last updated:** 2026-08-25 — Portfolio Scoring page added (`/portfolio`); all prior PRs merged (through #48).
...
**Open PRs:** none — all prior PRs (#34–#48) merged. Branch `claude/dreamy-dirac-8s1qwi` has the new Portfolio Scoring page (not yet PR'd).
...
**Test status:** 249 backend + 9 frontend, all passing. Frontend builds 1120+ static pages (550 product + 550 passport + routes incl. new /portfolio).
