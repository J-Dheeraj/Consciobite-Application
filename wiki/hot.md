...
**Last updated:** 2026-07-25 after Leaderboard page + products test coverage session.
...
**Current test status (main):** 137 backend tests passing. With `claude/nifty-goodall-v4sm14` branch: 147 tests (+10 new products-route coverage tests). Frontend builds 567 static pages (17 routes + 550 product pages, including new /leaderboard). PR #34 (DPP frontend, 36 passport tests) still open.
...
**Active branch:** `claude/nifty-goodall-v4sm14` — pushed, no PR yet.
