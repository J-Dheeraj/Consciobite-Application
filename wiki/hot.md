...
**Last updated:** 2026-05-29 after governance Session 3 implementation.
...
**Transparency features (2026-05-29 → Session 3):** Public `/api/transparency` endpoint (no auth) returns aggregate scoring integrity stats, advisory board placeholder (3 seats — all "Recruiting"), and independence statement. Frontend page at `frontend/src/app/transparency/page.js`. Navbar now links to `/transparency`. `fetchTransparency()` added to `frontend/src/services/recipes.js` and re-exported from `api.js`.
