...
**Last updated:** 2026-08-19 — evidence sources now surfaced on the Transparency page (branch `claude/dreamy-dirac-y4m5ee`, commit `a04ac7a`). All 249 backend tests pass. No open PRs or GitHub issues.
