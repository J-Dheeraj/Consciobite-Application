...
**Last updated:** 2026-08-06 — admin hub + evidence review UI added (commit `91c81ab`). All PRs merged as of 2026-08-06; 260 backend tests passing.
...
**Open PRs:** none as of 2026-08-06. All previous PRs (#34–#47) are merged into main. Current work is on `claude/nifty-goodall-j5njyc`.
...
**Test status:** 260 backend + 9 frontend, all passing. Frontend builds 1119 static pages (550 product + 550 passport + routes). 11 new backend tests cover admin pending-evidence and evidence review endpoints.
