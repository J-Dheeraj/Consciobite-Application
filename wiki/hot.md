...
**Last updated:** 2026-07-08 after passport tests, CONTRIBUTING.md, and passport export UI.
...
**Current test status:** 156 backend tests passing (7 suites). Frontend builds 566 static pages (16 routes + 550 product pages).

**Active branch:** `claude/nifty-goodall-19o7n6` — pushed 2026-07-08.

**Recent work (2026-07-08):**
- `backend/__tests__/passport.test.js` added — 19 integration tests for the v1 passport, portfolio, and audit routes (gap from PR #33)
- `CONTRIBUTING.md` created — covers setup, branch naming, commit conventions, PR checklist, security rules
- `frontend/src/services/passport.js` added — `fetchProductPassport()` + `downloadPassportJson()`
- "Export Digital Passport" button added to `ProductDetailClient` — fetches `/api/v1/passport/:id` and downloads JSON
