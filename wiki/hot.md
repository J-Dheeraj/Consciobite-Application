...
**Last updated:** 2026-06-23 — wiki sync after two unsynced merges (governance frontend, Digital Product Passport API). No code changes this session; repo state is healthy (CI green on `main` at `f0c40d4`, no open PRs/issues).
