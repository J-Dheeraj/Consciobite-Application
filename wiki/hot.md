...
**Last updated:** 2026-06-30 — passport tests and CONTRIBUTING.md session.
...
**Current test status:** 159 backend tests passing (117 original + 20 admin governance + 22 Digital Product Passport). Frontend builds 566 static pages (16 routes + 550 product pages).

**Active branch:** `claude/dreamy-dirac-uet56m` — fresh branch from main, developing on top of PRs #29–#33 which are all merged.
