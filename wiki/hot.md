...
**Last updated:** 2026-06-15 after passport API test session.
...
**Active branch:** `claude/nifty-goodall-mfpd7o` — work-in-progress against `main`.

**Digital Product Passport API (2026-06-15):** 3 endpoints under `/api/v1` — `GET /passport/:id`, `POST /portfolio/score`, `GET /audit/:id`. 26 integration tests added (`passport.test.js`). qs/express/body-parser bumped to fix DoS advisory (0 vulnerabilities).
