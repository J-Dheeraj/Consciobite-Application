...
**Last updated:** 2026-07-13 after user profile page addition.
...
**Current test status:** 137 backend tests passing. Frontend builds 567 static pages (17 routes + 550 product pages — /profile added).

**Active branch:** `claude/dreamy-dirac-2rzf1z`.
...
**Recent work (2026-07-13):** Added `/profile` page — auth-gated, shows account info (name, email, join date), carbon activity tiles (total logs, total/weekly emissions), quick-access links. Navbar username is now a link to `/profile` on desktop and mobile.
