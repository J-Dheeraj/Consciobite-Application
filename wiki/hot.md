...
**Last updated:** 2026-05-21 after CI fix session (dreamy-dirac branch).
...
**Active branch:** `claude/dreamy-dirac-9KsYf` — governance layer + CI fix pushed. PR #30 (`claude/improve-application-S5njo`) was failing CI due to un-Prettified `admin.js`; fixed on the new branch.
