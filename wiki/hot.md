...
**Last updated:** 2026-08-10 — admin evidence review UI added (branch `claude/nifty-goodall-fetwmg`, commit `a43ede0`); 10 new backend tests.
...
**Open PRs:** All previously open PRs (#34–#47) are now merged. One new open branch: `claude/nifty-goodall-fetwmg` carrying the admin evidence review UI (not yet PR'd).
...
**Test status:** 259 backend + 9 frontend, all passing. Frontend builds 1119 static pages (550 product + 550 passport + routes). New `/admin/evidence` page adds 1 more static route.
