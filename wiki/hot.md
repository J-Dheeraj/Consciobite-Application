...
**Last updated:** 2026-06-08 after passport test session.
...
**Digital Product Passport API (2026-06-07, PR #33 merged):** B2B endpoints at `/api/v1/passport/:productId`, `/api/v1/portfolio/score`, `/api/v1/audit/:productId`. EU ESPR + SGX Scope 3 reporting. `ApiReadyGate` cold-start component added. `METHODOLOGY.md` and updated `README.md` at repo root.

**Current test status:** 156 backend tests passing (117 original + 20 governance + 19 passport). Frontend builds 566 static pages (16 routes + 550 product pages).

**Active branch:** `claude/dreamy-dirac-593rzv` — passport tests committed and pushed.
