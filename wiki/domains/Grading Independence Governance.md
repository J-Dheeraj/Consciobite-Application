...
1. ~~**Public methodology page enhancement**~~ ✅ Done — full algorithm, data sources, confidence scoring
2. **Scoring changelog** ✅ Done (2026-07-11) — `methodology_changelog` DB table, seeded with v1/v2/v3 history. Public API + admin write endpoint. Shown on `/methodology` page.
3. ~~**Board disclosure page**~~ ✅ Done — `/transparency` page with panel seats and conflict-of-interest commitments
4. ~~**Audit trail**~~ ✅ Done — `scoreAudit.js` logs every score change with paying-client flag
...
| `frontend/src/app/methodology/page.js` | Public methodology page with changelog section | Done (2026-07-11) |
| `frontend/src/app/transparency/page.js` | Public governance & stats page | Done |
| `frontend/src/app/admin/page.js` | Admin landing page with integrity check | Done (2026-07-11) |
| `backend/src/db/migrations/003_methodology_changelog.sql` | Methodology changelog table + seed data | Done (2026-07-11) |
