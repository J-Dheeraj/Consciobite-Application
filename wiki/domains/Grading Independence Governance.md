...
- Methodology page exists at `/methodology` in the frontend — now links to transparency report
...
- **Public transparency endpoint** — `GET /api/transparency` exposes aggregate bias stats, score distribution, advisory board status, and commitments (no individual data)
- **Public transparency page** — `/transparency` frontend page with live governance dashboard
- Advisory board not yet formed (business initiative, not code)
- Phase 2 transparency features complete (Session 3)
...
| `backend/src/routes/transparency.js` | Public aggregate stats endpoint | Done (Session 3) |
| `frontend/src/app/methodology/page.js` | Public methodology page — transparency link added | Done (Session 3) |
